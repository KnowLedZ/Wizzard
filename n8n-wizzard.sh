...
run_silent "Download Docker" curl -fsSL https://get.docker.com -o get-docker.sh
run_silent "Install Docker" sh get-docker.sh
run_silent "Start Docker" bash -c "systemctl start docker || service docker start || true"
...
run_silent "Clone repository" git clone https://github.com/KnowLedZ/n8n-http.git . || true
